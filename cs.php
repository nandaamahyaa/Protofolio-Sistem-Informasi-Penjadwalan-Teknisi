...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			<li><a href="<?= base_url();?>cs/Homecs"><em class="fa fa-home"></em></a></li>
	...
	<div class="table-responsive lowermost">
		...
		<a href="<?= base_url();?>cs/Teknisics/tambah" class="btn btn-primary" type="tambah" name="tambah" style="margin:5px 5px 5px 5px"> Tambah  Teknisi </a>
			<!--template table-->
			...
			<?php foreach($teknisi as $row):?>
				<tr>
					...
					<td><?= $row["No_HP"];?></td>
					<td>
						<a href="<?= base_url();?>cs/Teknisics/ubah/<?=$row['id_teknisi'];?>" style="color:black"class="fa fa-pencil-square-o"></a>
					</td>
				</tr>
			<?php $i ++; ?>
			<?php endforeach;?>
